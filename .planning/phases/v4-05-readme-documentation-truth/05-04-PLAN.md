...
**Files:** `README.md`, `docs/VELESQL_SPEC.md`

**Action:**
1. **Final consistency scan across both files:**
   - Version references consistent
   - Feature status consistent between README and VELESQL_SPEC.md
...
- [ ] README and VELESQL_SPEC.md internally consistent
...
**Shared read files:** `docs/VELESQL_SPEC.md` (consistency check), benchmark files
