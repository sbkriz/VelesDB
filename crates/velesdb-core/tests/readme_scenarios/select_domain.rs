...
fn test_scenario1_medical_research() {
    ...
    // 8 studies: mix of BRCA1/non-BRCA1 content and pre/post-2025 dates
    let nodes = vec![
        (
            1,
            helpers::generate_embedding(10, 128),
            json!({
                "study_id": "S001", "title": "BRCA1 Gene Mutations in Cancer",
                "content": "Study on BRCA1 gene mutations and their role in breast cancer",
        ...
        (
            ...
            json!({
                "study_id": "S002", "title": "mRNA Vaccine Development",
                "content": "Novel mRNA approaches for respiratory diseases",
        ...
        (
            ...
            json!({
                "study_id": "S003", "title": "BRCA1 Targeted Therapy",
                "content": "Targeted therapies for BRCA1 mutation carriers",
        ...
        (
            ...
            json!({
                "study_id": "S004", "title": "Cardiovascular Risk Factors",
                "content": "Analysis of heart disease risk factors in populations",
        ...
        (
            ...
            json!({
                "study_id": "S005", "title": "BRCA1 and Ovarian Cancer",
                "content": "Correlation between BRCA1 mutations and ovarian cancer risk",
        ...
        (
            ...
            json!({
                "study_id": "S006", "title": "Immunotherapy Advances",
                "content": "PD-1 checkpoint inhibitors in oncology",
        ...
        (
            ...
            json!({
                "study_id": "S007", "title": "BRCA1 Expression Patterns",
                "content": "Expression of BRCA1 in normal and tumor tissues",
        ...
        (
            ...
            json!({
                "study_id": "S008", "title": "Genomic Sequencing Methods",
                "content": "Next-generation sequencing of cancer genomes",
...
fn test_scenario2_ecommerce() {
    ...
    let nodes = vec![
        (
            ...
            json!({
                "product_id": "P001", "name": "Wireless Mouse", "price": 29.99, "category": "electronics"
            }),
        ),
        (
            2,
            ...
            json!({
                "product_id": "P002", "name": "USB-C Hub", "price": 49.99, "category": "electronics"
            }),
        ),
        (
            3,
            ...
            json!({
                "product_id": "P003", "name": "4K Monitor", "price": 399.99, "category": "electronics"
            }),
        ),
        (
            4,
            ...
            json!({
                "product_id": "P004", "name": "Bluetooth Speaker", "price": 79.99, "category": "electronics"
            }),
        ),
        (
            5,
            ...
            json!({
                "product_id": "P005", "name": "Running Shoes", "price": 89.99, "category": "sports"
            }),
        ),
        (
            6,
            ...
            json!({
                "product_id": "P006", "name": "Yoga Mat", "price": 35.00, "category": "sports"
            }),
        ),
        (
            7,
            ...
            json!({
                "product_id": "P007", "name": "Coffee Table", "price": 149.99, "category": "home"
            }),
        ),
        (
            8,
            ...
            json!({
                "product_id": "P008", "name": "Desk Lamp", "price": 45.00, "category": "home"
            }),
        ),
        (
            9,
            ...
            json!({
                "product_id": "P009", "name": "Earbuds", "price": 59.99, "category": "electronics"
            }),
        ),
        (
            10,
            ...
            json!({
                "product_id": "P010", "name": "Phone Case", "price": 15.99, "category": "electronics"
            }),
        ),
        (
            11,
            ...
            json!({
                "product_id": "P011", "name": "Keyboard", "price": 89.99, "category": "electronics"
            }),
        ),
        (
            12,
            ...
            json!({
                "product_id": "P012", "name": "Webcam", "price": 69.99, "category": "electronics"
            }),
        ),
    ];
    helpers::insert_labeled_nodes(&collection, &nodes);
...
fn test_scenario3_cybersecurity() {
    ...
    let nodes = vec![
        (
            ...
            json!({
                "malware_hash": "abc123", "threat_level": 0.95, "first_seen": 1738000000_i64
            }),
        ),
        (
            2,
            ...
            json!({
                "malware_hash": "def456", "threat_level": 0.85, "first_seen": 1738100000_i64
            }),
        ),
        (
            3,
            ...
            json!({
                "malware_hash": "ghi789", "threat_level": 0.50, "first_seen": 1738200000_i64
            }),
        ),
        (
            4,
            ...
            json!({
                "malware_hash": "jkl012", "threat_level": 0.92, "first_seen": 1735000000_i64
            }),
        ),
        (
            5,
            ...
            json!({
                "malware_hash": "mno345", "threat_level": 0.30, "first_seen": 1737900000_i64
            }),
        ),
        (
            6,
            ...
            json!({
                "malware_hash": "pqr678", "threat_level": 0.88, "first_seen": 1738300000_i64
            }),
        ),
        (
            7,
            ...
            json!({
                "malware_hash": "stu901", "threat_level": 0.96, "first_seen": 1700000000_i64
            }),
        ),
        (
            8,
            ...
            json!({
                "malware_hash": "vwx234", "threat_level": 0.91, "first_seen": 1738050000_i64
            }),
        ),
        (
            9,
            ...
            json!({
                "malware_hash": "yza567", "threat_level": 0.60, "first_seen": 1730000000_i64
            }),
        ),
        (
            10,
            ...
            json!({
                "malware_hash": "bcd890", "threat_level": 0.89, "first_seen": 1738400000_i64
            }),
        ),
    ];
    helpers::insert_labeled_nodes(&collection, &nodes);
